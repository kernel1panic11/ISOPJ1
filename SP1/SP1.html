...
    </div>
    <div class="content-section">
        <h2 class="sub">Postinstalación y personalización</h2>
        <p>
...
    <p>Y elegimos qué archivos y carpetas queremos hacer snapshot.</p>
...
    <p>Y ahora aplicamos las configuraciones y comprobamos que da internet.</p>
...
<div class="content-section"> 
     <p>He hecho las cosas de una forma un poco distinta, en mi caso como Ubuntu me estaba dando algunos problemas, he cambiado a Debian 13 directamente para este apartado. Lo que haré es instalar Audacity y luego me moveré a la rama inestable de Debian para obtener una versión más moderna. Sé que podría indicarle al apt que me instale un paquete anterior con <code>apt install "nombre paquete"="version paquete"</code>, pero me resulta más cómodo así.</p>
     <p>Empezamos instalando apt con <code>apt install audacity -y</code>. Le pongo el <code>-y</code> para que se instale automáticamente sin pedir confirmación.</p>
...
    <img width="1125" height="703" alt="image" src="https://github.com/user-attachments/assets/74cd8433-842f-41f7-a0f3-9318e92da91d" class="course-image"/>
	...
	<p>Antes de empezar la actualización voy a ir a <code>/etc/apt/preferences.d/</code> y allí crearé un archivo nuevo que le puedo poner el nombre que yo quiera, en mi caso le pondré "pin".</p>
	...
	<p>He puesto el <code>Pin: release *</code> ya que eso indica que coja cualquier versión, es decir que si tengo instalada la 1.4 que coja la que tenga instalada, y el <code>Pin-Priority: -1</code> porque así le indico a apt que nunca lo actualice, bajo ninguna circunstancia.</p>
	...
	<p>Ahora lo que he hecho es con el comando <code>apt-cache policy audacity</code> es comprobar que la política de que no se actualice se cumple.</p>
	...
	<p>Ahora después de actualizar comprobamos la versión con <code>apt-cache policy</code>.</p>
	<img width="745" height="89" alt="image" src="https://github.com/user-attachments/assets/5fd10c5c-b857-44d6-bf47-2aa13229094b" class="course-image"/>
...
<style>
:root {
    /* Esto anula el fondo por defecto y pone el de pract1.gif */
...
    border-radius: var(--radius); /* Corregido: Se eliminó la barra "/" */
