...
<div class="content-section"> 
    ...
    <p>Aquí dejo un video como se puede ver que el único sistema que arranca es Windows 11:</p>
    <video src="2025-10-02 12-30-44.mp4" controls width="100%" class="course-image"></video>
    <p>Ahora lo que hago es irme a la UEFI de la máquina virtual y arranco en el CD donde tengo el Super Grub para restaurar el GRUB.</p>
    ...
    <p>Ahora en el Super Grub2 Disk elijo la opción de "Detect and show boot methods".</p> 
    ...
    <p>Una vez aquí lo que hay que hacer es seleccionar donde tengo el Linux para que arranque.</p>
