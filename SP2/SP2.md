...
<main class="contenedor-principal">
 ...
    </div>
    <div>
        <p>Para empezar, crearemos un disco virtual nuevo en VMware, lo normal es crear una SATA pero en mi caso le he indicado NVME ya que así va más <strong>rápido</strong>, como se puede ver, el disco duro es de 10 GB </p>
 ...
    <p>Aquí lo que hago es crear un usuario con <code>adduser</code>, con este comando automáticamente se te creará la carpeta home, pero no los archivos dentro de la home, esos se crearán cuando inicies sesión con él</p>
 ...
    <p>Ahora que hemos creado el usuario con <code>useradd</code> no crea la home y la shell es sh en vez de bash, aquí lo cambiamos</p>
...
<img width="399" height="31" alt="image" src="httpss://github.com/user-attachments/assets/f0e8a615-1156-4852-9587-cefd89ba2511" class="course-image"/>
...
<p>Este comando sirve para establecer el grupo principal de un usuario, un usuario puede estar en un <strong>único</strong> grupo principal pero en todos los que quiera secundarios</p>
<img width="551" height="141" alt="image" src="httpss://github.com/user-attachments/assets/cb66469f-eca2-47bd-8c39-3f8bd52fc635" class="course-image"/>
...
<p>En el <strong>directorio</strong> /etc/skel sirve para que cuando creemos un usuario con <code>adduser</code> se copie todo lo que hay en esa carpeta al nuevo usuario</p>
...
<p><strong>También</strong> he editado que el usuario su home sea /k/</p>
...
<p>Aquí ponemos cada <strong>cuánto</strong> tiene que expirarle la contraseña</p>
...
<p>Ahora editamos la shell del <code>useradd</code></p>
